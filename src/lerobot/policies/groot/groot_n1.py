...
class GR00TN15Config(PretrainedConfig):
    ...
    backbone_cfg: dict = field(init=False, metadata={"help": "Backbone configuration."},default=None)

    action_head_cfg: dict = field(init=False, metadata={"help": "Action head configuration."},default=None)

    action_horizon: int = field(init=False, metadata={"help": "Action horizon."},default=None)

    action_dim: int = field(init=False, metadata={"help": "Action dimension."},default=None)
