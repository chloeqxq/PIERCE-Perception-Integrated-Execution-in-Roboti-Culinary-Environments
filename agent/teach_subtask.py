...
def record_loop(
    ...
    while timestamp < control_time_s:
        ...
        if events["exit_early"]:
            events["exit_early"] = False
            break
        if events["subtask_key"] is not None:
            subtask_key = events["subtask_key"]
            # print(subtask_key)
            # print(subtask_dict)
            try:
                current_task = subtask_dict[subtask_key]
                log_say(f"new task: {current_task}")
            except:
                pass
            finally:
                events["subtask_key"] = None
        ...
        with VideoEncodingManager(dataset):
            ...
            while recorded_episodes < cfg.dataset.num_episodes and not events["stop_recording"]:
                ...
                record_loop(
                    ...
                    current_task=cfg.dataset.initial_task,
                    subtask_dict=cfg.dataset.subtask_dict,
